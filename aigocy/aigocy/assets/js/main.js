...
(function ($) {
    ...
    var services_btn = () => {
        $('.services-image-btn').on('click', function(){
            if(!$(this).hasClass('active-img')) {
                ...
                $('.svc-img').removeClass('svc-img-active');
                $('.svc-img[src="' + newImg + '"]').addClass('svc-img-active');
            }
        });
    };
    // counter
    ...
    var stickyHeader = function () {
        ...
        var lastScrollTop = 0;
        var scrollThreshold = 150; // px before behavior kicks in
        ...
        $(window).on("scroll", function () {
            ...
            if (scrollTop > scrollThreshold) {
                // Past the threshold — enable fixed mode
                if (!$header.hasClass("header-scrolled")) {
                    $header.addClass("header-scrolled header-hidden");
                    // Force reflow so the hidden state applies before transition
                ...
                // Back near the top — restore original position
                $header.removeClass("header-scrolled header-hidden header-visible");
            }
